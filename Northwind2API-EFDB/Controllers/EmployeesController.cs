...
namespace Northwind2API_EFDB.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        {
            var employee = await _context.Employee.Include(e => e.EmployeeTerritory).ThenInclude(et => et.Territory).ThenInclude(t => t.Region).FirstOrDefaultAsync(e => e.EmployeeId == id);
